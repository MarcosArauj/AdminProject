                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control" name="senha" id="senha" placeholder="Password"  value="<?php echo htmlspecialchars( $empresa["senha"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" required>
