...
<head>
    ...
    <!-- Bootstrap 3.3.6 -->
    <link rel="stylesheet" href="/App/Views/res/bootstrap/css/bootstrap.css">
    ...
    -->
    <link rel="stylesheet" href="/App/Views/res/adminLte/dist/css/skins/skin-green.min.css">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="/perfil" class="logo">
            ...
            <span class="logo-mini"><b><?php echo getIniciaisUsuario(); ?></b></span>
            <!-- Nome do Usuario Logado -->
            <span><b style="font-size: 20px"><?php echo getNomeUsuario(); ?></b></span>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="/admin/produtos/cadastra">Cadastrar</a></li>
                        <li><a href="/admin/produtos">Listar</a></li>
                    </ul>
                </li>
                <li class="treeview">
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i> <span>Promoções</span>
                        <span class="pull-right-container">
                         <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
