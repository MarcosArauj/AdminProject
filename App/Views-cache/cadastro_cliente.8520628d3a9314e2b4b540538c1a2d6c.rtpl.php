...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="/admin/clientes"> Cliente</a></li>
            <li class="active"><a href="/admin/clientes/cadastra">Cadastrar</a></li>
        </ol>
    </section>
...
<section class="content">
            ...
            <div class="box box-success">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form  role="form" action="/admin/clientes/cadastra" name="FormCadastro" method="post">
                  <div class="box-body">
                      <div class="col-md-6">
